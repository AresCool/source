...
rem "rem"命令为注释命令不执行,此行起为命令注释
rem @echo off                                             关闭回显
rem color f5                                              设定颜色,颜色属性由两个十六进制数字指定.第一个为背景，第二个则为前景。每个数字可以为以下任何值之一:0=黑色8=灰色1=蓝色9=淡蓝色2=绿色A=淡绿色3=湖蓝色B=淡浅绿色4=红色C=淡红色5=紫色D=淡紫色6=黄色E=淡黄色7=白色F=亮白色
rem echo.                                                 空出一行
rem echo 现在……                                         回显一行字
